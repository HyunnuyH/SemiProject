...
public class AdminChallengeServelt extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Challenge> challenges=new AdminChallengeService().searchChallenge(cPage,numPerpage);
		...
		request.setAttribute("challenge", challenges);
		System.out.println(challenges);
		RequestDispatcher rd=request.getRequestDispatcher("/views/admin/adminChallenge.jsp");
